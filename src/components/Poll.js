...
class Poll extends React.Component {
	...
	displayCustomizeButtons() {
		return (
			<div>
				<button className="edit-announcement-button" onClick={this.handleOpenModal}>&#9998; Edit Poll</button>
				<button className="delete-announcement-button" onClick={this.deleteAnnouncement}>Delete Poll &#10007;</button>
			</div>
		);
    }
			...
			<div className="announcement">
				...
				<ReactModal isOpen={this.state.showModal} contentLabel="Edit Announcement" ariaHideApp={false} className="edit-announcement-modal">
					<form className="edit-announcement-form" onSubmit={this.editAnnouncement}>
						...
						<br />
						<input type="submit" value="Update Poll" className="update-announcement-button" />
